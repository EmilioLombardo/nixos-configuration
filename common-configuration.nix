...

{
  ...
  users.users.emilio = { # {{{
    ...
    openssh.authorizedKeys.keys = [
      "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIE2x/XJb4aWJdnd+vWz7biG0PXXAnN1FR9wOiocG0Rix emilomb3@gmail.com" # macbook
      "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIOcEkos+BmHJWg8gelAaa9QQ6rFO+bhUn9388Fk+RV/o Generated By Termius" # iPhone13
      "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIH0rH2r6xSE3UaCaw3sABvM8md5BHLazMoe2mhbP6mhE emilomb3@gmail.com" # emiliobl@login.stud.ntnu.no
    ];
